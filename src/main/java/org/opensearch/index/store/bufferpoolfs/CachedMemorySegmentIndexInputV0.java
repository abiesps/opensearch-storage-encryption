...
public class CachedMemorySegmentIndexInputV0 extends IndexInput implements RandomAccessInput {
    ...
    /**
     * Creates a new CachedMemorySegmentIndexInputV0 instance.
     * 
     ...
     * @return a new CachedMemorySegmentIndexInputV0 instance
     */
    public static CachedMemorySegmentIndexInputV0 newInstance(
        ...
        CachedMemorySegmentIndexInputV0 input = new CachedMemorySegmentIndexInputV0(
            resourceDescription,
            path,
            0,
            length,
    ...
    private CachedMemorySegmentIndexInputV0(
        String resourceDescription,
        Path path,
    ...
    */
    ...
    @Override
    public final CachedMemorySegmentIndexInputV0 clone() {
        final CachedMemorySegmentIndexInputV0 clone = buildSlice((String) null, 0L, this.length);
        try {
     ...
     */
    @Override
    public final CachedMemorySegmentIndexInputV0 slice(String sliceDescription, long offset, long length) throws IOException {
    ...
    CachedMemorySegmentIndexInputV0 buildSlice(String sliceDescription, long sliceOffset, long length) {
        ensureOpen();
        ...
        CachedMemorySegmentIndexInputV0 slice = new CachedMemorySegmentIndexInputV0(
